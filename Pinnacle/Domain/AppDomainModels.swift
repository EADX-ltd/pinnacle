...
struct ToolState: Equatable, Codable {
    ...
    static let `default` = ToolState(
        activeTool: .pen,
        configs: [
            .pen: ToolConfig(colorHexRGBA: "#FF3B30FF", strokeWidth: 1, opacity: 1),
            ...
            .rectangle: ToolConfig(colorHexRGBA: "#34C759FF", strokeWidth: 1, opacity: 1),
            .ellipse: ToolConfig(colorHexRGBA: "#AF52DEFF", strokeWidth: 1, opacity: 1),
